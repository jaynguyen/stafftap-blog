(function($){
	...
	// Theme Driver
	// ============================
	var ThemeDriver = function(){

		var theMan = this;

		theMan.els = {

			btn_close_mobile: $("#btn-close-mobile, .close-mobile"),
			btn_open_mobile: $("#btn-open-mobile, .open-mobile"),

		}; //

		theMan.params = {
			cls_mobile: "show-mobile"
		}; //

		theMan.init = function(){
		...
		//
		theMan.activate_menu = function(){

			if(theMan.els.btn_close_mobile.length > 0){
				$(theMan.els.btn_close_mobile).on("click", function(e){
					e.preventDefault();
					$("body").removeClass(theMan.params.cls_mobile);
				});//
			}


			if(theMan.els.btn_open_mobile.length > 0){
				$(theMan.els.btn_open_mobile).on("click", function(e){
					e.preventDefault();
					$("body").addClass(theMan.params.cls_mobile);
				});//
			}
	...
	$(document).ready(function($){
		...
		var theme_driver = new ThemeDriver();
		theme_driver.init();
