!function(a) {
    ...
    var c = function() {
        var b = this;
        b.els = {
            btn_close_mobile: a("#btn-close-mobile, .close-mobile"),
            btn_open_mobile: a("#btn-open-mobile, .open-mobile")
        }, b.params = {
            cls_mobile: "show-mobile"
        }, b.init = function() {
            this.activate_menu();
        }, b.activate_menu = function() {
            b.els.btn_close_mobile.length > 0 && a(b.els.btn_close_mobile).on("click", function(c) {
                c.preventDefault(), a("body").removeClass(b.params.cls_mobile);
            }), b.els.btn_open_mobile.length > 0 && a(b.els.btn_open_mobile).on("click", function(c) {
                c.preventDefault(), a("body").addClass(b.params.cls_mobile);
            });
        };
    }, d = function() {
        this.els = {
